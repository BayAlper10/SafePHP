...
<script type="text/javascript" src="safephp/eklentiler/js/swfupload/swfupload.js"></script>
<script type="text/javascript" src="safephp/eklentiler/js/jquery.swfupload.js"></script>
<link rel="stylesheet" href="safephp/eklentiler/js/jquery.swfupload.css" type="text/css" />
...
$(function(){
	$('#swfupload-control').swfupload({
		...
		flash_url : "safephp/eklentiler/js/swfupload/swfupload.swf",
		button_image_url : 'safephp/eklentiler/js/swfupload/resim_yukle_buton.png',
		button_width : 114,
		button_height : 29,
...
?>
<?php function giris($oturum="KByonetim",$odeger="safephp",$seviye="yonetici",$adres="index.php") {?>
<?php
